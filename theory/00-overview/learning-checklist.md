...
- [ ] `rdb-vs-dynamodb.md`의 비교 표를 읽고 내 프로젝트 관점으로 해석했다.
- [ ] `reflection.md`에 자기 말로 답을 적었다.

## 다음 주제로 넘어가기 전 질문

- [ ] 내가 만들 API는 어떤 key로 조회되는지 먼저 묻는 습관이 왜 필요한가?
- [ ] SQL처럼 생각하면 DynamoDB에서 어떤 문제가 생길 수 있는가?
- [ ] Stage 2를 바로 구현하지 않고 이론 트랙을 먼저 보는 이유는 무엇인가?
